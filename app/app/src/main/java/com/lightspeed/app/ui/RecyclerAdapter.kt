...
class RecyclerAdapter: ListAdapter<Row, ViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return when (viewType) {
            CONTACT_VIEW_TYPE -> ContactViewHolder(ContactViewHolderBinding.inflate(inflater, parent, false))
...
class ContactViewHolder(private val binding: ContactViewHolderBinding) : ViewHolder(binding.root) {
